...
public class ControllerData extends AbstractData {
    ...
    public ControllerData(otmui.item.Controller uicontroller) {
        ...
        // id .................
        X.add(UIFactory.createLabelText("id", controller.getId().toString()).pane);

        // algorithm type;
        X.add(UIFactory.createLabelText("algorithm", controller.type.toString()).pane);

        // Set<AbstractActuator> actuators;
        X.add(UIFactory.createLabelList("actuators",
